...
var author$project$Main$viewError = function (errorMessage) {
	return elm$html$Html$text('Error: ' + errorMessage);
};
...
var author$project$Main$scaled = function (scalar) {
	return elm$core$Basics$round(
		A3(mdgriffith$elm_ui$Element$modular, 16, 1.25, scalar));
};
...
var author$project$Main$viewIntro = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Thanks, for being a friend!')
				])),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('In addition to the physical thrift finds, you are treated to the following Evansville area music found online.')
				])),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Your friend,')
				])),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Font$typeface('Charm')
						]))
				]),
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Jared M. Smith')
				]))
		]));
...
var author$project$Main$embedFull = function (embeddedHtml) {
	return A2(
		...
		mdgriffith$elm_ui$Element$html(embeddedHtml));
};
...
var author$project$Main$andreaWirthAndDirtyLilFunHavers = author$project$Main$embedFull(
	A2(
		...
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$attribute, 'height', '400'),
				elm$html$Html$Attributes$src('https://www.iheart.com/artist/andrea-wirth-the-dirty-lil-30077778/?embed=true'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
var author$project$Main$bigNinjaDelight = author$project$Main$embedFull(
	A2(
		elm$html$Html$iframe,
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$attribute, 'allow', 'autoplay'),
				A2(elm$html$Html$Attributes$attribute, 'frameborder', 'no'),
				A2(elm$html$Html$Attributes$attribute, 'height', '450'),
				A2(elm$html$Html$Attributes$attribute, 'scrolling', 'no'),
				elm$html$Html$Attributes$src('https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/488101206&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
var author$project$Main$calabash = author$project$Main$embedFull(
	A2(
		elm$html$Html$iframe,
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$attribute, 'height', '450'),
				A2(elm$html$Html$Attributes$attribute, 'scrolling', 'no'),
				elm$html$Html$Attributes$src('https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/116034337&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
var author$project$Main$cicada = author$project$Main$embedFull(
	A2(
		elm$html$Html$iframe,
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$attribute, 'allow', 'autoplay'),
				A2(elm$html$Html$Attributes$attribute, 'frameborder', 'no'),
				A2(elm$html$Html$Attributes$attribute, 'height', '166'),
				A2(elm$html$Html$Attributes$attribute, 'scrolling', 'no'),
				elm$html$Html$Attributes$src('https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/145253471%3Fsecret_token%3Ds-Ek7mG&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
var author$project$Main$dangHeathens = author$project$Main$embedFull(
	A2(
		elm$html$Html$iframe,
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$attribute, 'frameborder', 'no'),
				A2(elm$html$Html$Attributes$attribute, 'height', '265'),
				A2(elm$html$Html$Attributes$attribute, 'scrolling', 'no'),
				elm$html$Html$Attributes$src('https://www.reverbnation.com/widget_code/html_widget/artist_2445122?widget_id=55&pwc[included_songs]=1&context_type=page_object&pwc[size]=small'),
				A2(elm$html$Html$Attributes$attribute, 'style', 'width:0px;min-width:100%;max-width:100%;'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
...
var author$project$Main$musicGroupTitle = function (title) {
	return A2(
		mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
			[
...
var author$project$Main$queenExchange = author$project$Main$embedFull(
	A2(
		elm$html$Html$iframe,
		_List_fromArray(
			[
				...
				A2(elm$html$Html$Attributes$attribute, 'height', '450'),
				A2(elm$html$Html$Attributes$attribute, 'scrolling', 'no'),
				elm$html$Html$Attributes$src('https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/9469341&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true'),
				A2(elm$html$Html$Attributes$attribute, 'width', '100%')
			]),
		_List_Nil));
...
var author$project$Main$viewMusic = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('Andrea Wirth and the Dirty Lil\' Fun Havers')),
				author$project$Main$andreaWirthAndDirtyLilFunHavers,
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('Big Ninja Delight')),
				author$project$Main$bigNinjaDelight,
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('Calabash')),
				author$project$Main$calabash,
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('Dang Heathens')),
				author$project$Main$dangHeathens,
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('The Queen Exchange')),
				author$project$Main$queenExchange,
				author$project$Main$musicGroupTitle(
				mdgriffith$elm_ui$Element$text('Suspekt')),
				author$project$Main$cicada
			]));
};
...
var author$project$Main$viewContent = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 229, 220, 197)),
				mdgriffith$elm_ui$Element$padding(30),
				mdgriffith$elm_ui$Element$spacing(30),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
			]),
		_List_fromArray(
			[
				...
				author$project$Main$viewMusic(model)
			]));
};
...
var author$project$Main$viewHeading = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 193, 73, 83)),
		...
		mdgriffith$elm_ui$Element$text('Friendsmas 2018'));
};
...
var author$project$Main$viewPageSuccess = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$layout,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$Background$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 76, 76, 71)),
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$typeface('Muli'),
		...
		A2(
			...
			_List_fromArray(
				[
					author$project$Main$viewHeading(model),
...
var author$project$Main$viewPage = function (model) {
	...
	switch (_n0.$) {
		...
		case 'Loaded':
			return author$project$Main$viewPageSuccess(model);
		default:
